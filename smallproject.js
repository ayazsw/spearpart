const items = [
  ...
  { name: "Motor Oil Group-I base oil SAE 20W50 API-SG/CD (per Liter)", price: "780.00" },
  { name: "Motor Oil Group-II White Oil Imported SAE 20W50 API-SM (per Liter)", price: "1150.00" },
  { name: "Motor Oil Group-II White Oil Imported SAE 10W50 API-SN (per Liter)", price: "1250.00" },
  { name: "Motor Oil Group-I base oil SAE 20W50 API-cf4/cf/sg (per Liter)", price: "780.00" },
  { name: "Motor Oil Group-I base oil SAE-50 API-CD (per Liter)", price: "720.00" },
  { name: "Motor Oil Group-I base oil SAE-50 API-CC (per Liter)", price: "520.00" },
  { name: "Motor Oil Group-I base oil SAE 20W60 API-cf4/cf/sg (per Liter)", price: "850.00" },
  { name: "Tractor Oil Group-I oil Base oil (D-9000) API-cf4/cf/sg (per Liter)", price: "780.00" },
  { name: "Tractor Oil Group-I oil Base oil (D-8000) SAE-50 API-CD (per Liter)", price: "720.00" },
  { name: "Tractor Oil Group-I oil Base oil (D-1000) SAE-50 API-CC (per Liter)", price: "520.00" },
  { name: "Tractor Oil Group-I oil Base oil (D-3000) SAE-50 API-CD/SF (per Liter)", price: "520.00" },
  { name: "Tractor Oil Group-I oil Base oil (D-5000) SAE 20W50 API-CF/SF (per Liter)", price: "720.00" },
  { name: "Tractor Oil Group-I oil Base oil (D-3000) SAE-50 API-CD/CF (per Liter)", price: "720.00" },
...
document.getElementById("addbtn").addEventListener("click", function () {
  ...
  TotalCell.textContent = "Rs."+totalPrice.toLocaleString("en-IN", {
